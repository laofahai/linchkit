...
> 相关规范：[15 — AI 开发者体验](./15_ai_developer_experience.md)（evolver Agent）、[36 — AI 服务层](./36_ai_service.md)（ctx.ai）、[45 — 数据条件 Watcher](./45_reactive_automation.md)（`defineWatcher` 数据条件触发）、[22 — AI Rule Boundary](./22_ai_rule_boundary.md)（边界约束）。
>
> Tracking milestones:
...
>
> Related issues:
> - GitHub Issue `#81` — Evolution system
> - GitHub Issue `#88` — Evolution system
>
