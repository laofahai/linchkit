...
import { createProposalEngine } from "../../src/server-entry";

export const baseProposalOptions: CreateProposalOptions = {
...
export function createTestEngine(): ProposalEngine {
