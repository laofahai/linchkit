...
export default class TypeBuilder {
  ...
  IntentAlternative: ClassViewer<
    "IntentAlternative",
    "action" | "input" | "confidence" | "explanation"
  >;

  IntentResolution: ClassViewer<
    "IntentResolution",
    "action" | "input" | "confidence" | "explanation" | "alternatives"
  >;

  constructor() {
    this.tb = new _TypeBuilder({
      classes: new Set(["IntentAlternative", "IntentResolution"]),
      enums: new Set([]),
      runtime: DO_NOT_USE_DIRECTLY_UNLESS_YOU_KNOW_WHAT_YOURE_DOING_RUNTIME,
    });

    this.IntentAlternative = this.tb.classViewer("IntentAlternative", [
      "action",
      "input",
      "confidence",
      "explanation",
    ...
    this.IntentResolution = this.tb.classViewer("IntentResolution", [
      "action",
      "input",
      "confidence",
      "explanation",
