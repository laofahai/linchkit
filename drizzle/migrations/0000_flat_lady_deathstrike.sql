...
CREATE TYPE "_linchkit"."event_status" AS ENUM('pending', 'processing', 'completed', 'failed');--> statement-breakpoint
...
CREATE INDEX "idx_executions_tenant" ON "_linchkit"."executions" USING btree ("tenant_id","created_at");