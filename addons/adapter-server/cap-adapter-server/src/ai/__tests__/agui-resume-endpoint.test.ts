/**
 * AG-UI HITL resume endpoint tests (Spec 71 P2b).
 *
 ...
 * import.
 *
 * Handler-level unit tests live in agui-resume-handler.test.ts.
 * Shared fixtures live in helpers/agui-resume-helpers.ts.
 */

import { describe, expect, test } from "bun:test";
import { createAgUiApp, type ResumeEntry } from "@linchkit/cap-adapter-ag-ui";
