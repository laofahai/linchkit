/**
 * Shared test harness and fixtures for AG-UI HITL resume tests (Spec 71 P2b).
 * Extracted from agui-resume.test.ts to keep individual test files under 500 lines (#607).
 */

import type { AGUIEvent, InMemoryInterruptStore, ResumeEntry } from "@linchkit/cap-adapter-ag-ui";
