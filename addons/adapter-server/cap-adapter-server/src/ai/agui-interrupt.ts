/**
 * AG-UI HITL interrupt helpers — pure digest/canonical/interrupt-build utilities
 * extracted from agui-runner.ts (Spec 71 §4.2, §6.2, §6.7).
 *
 * These helpers are pure except for the single `store.put` side effect in
 * `buildProposeInterrupt`, making them independently testable and keeping
